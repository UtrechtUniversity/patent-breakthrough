...
class ModelHyperopt(): # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self,  # pylint: disable=too-many-arguments
                 ...
                 window_size: int,
                 n_jobs: int,
                 preprocessors: Optional[list[Callable]],
                 cpc_fp: Path,
                 patent_dir: Path
                 ) -> None:
    ...
    def _general_objective_func(self, label: str, model: object) -> Dict[str, Any]:
        models = {label: model}
        ...
        pp_prefix = "default-" # if preprocessors is None else "..."
